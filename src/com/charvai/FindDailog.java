...
public class FindDailog extends JFrame
    {
        ...
        FindDailog()
        {
            ...
            ActionListener ac1=new ActionListener()
            {
                ...
                {
                    if(dialog==null)
                        dialog=new FindDialog(FindDailog.this.ta);
                    dialog.showDialog(FindDailog.this,true);//find
            ...
            ActionListener ac2=new ActionListener()
            {
                public void actionPerformed(ActionEvent ev)
                {
                    if(dialog==null)
                        dialog=new FindDialog(FindDailog.this.ta);
                    dialog.showDialog(FindDailog.this,false);//find
                }
            };
